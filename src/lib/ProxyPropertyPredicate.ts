    ...
    ArrayProxyFieldPredicateInterface
{
  ...
  private buildCollectionFilterPredicateBuilder<P>(
    value: Expression,
    ...
    const propertyPaths =
      value == null ? null : typeof value === "object" && propertyPath in value ? value[propertyPath] : undefined;
