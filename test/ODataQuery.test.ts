...
describe("ODataQuery", () => {
  ...
  it("should set select filter with mulitple fields", () => {
    ...
    expect(query.provider.buildQuery(query.expression)).to.be.eql(
      `${endpoint}?$select=${encodeURIComponent("firstName,lastName")}`,
    );
  });

  it("should set combination select filter", () => {
    const query = baseQuery.select("firstName", "lastName").select("lastName");
  ...
  it("should set orderBy with multiple fields", () => {
    ...
    expect(query.provider.buildQuery(query.expression)).to.be.eql(
      `${endpoint}?$orderby=${encodeURIComponent("firstName,lastName")}`,
    );
  });
  ...
  it("should set orderBy multiple times", () => {
    ...
    expect(query.provider.buildQuery(query.expression)).to.be.eql(
      `${endpoint}?$orderby=${encodeURIComponent("firstName,lastName,age")}`,
    );
  });
  ...
  it("should set orderByDescending", () => {
    ...
    expect(query.provider.buildQuery(query.expression)).to.be.eql(
      `${endpoint}?$orderby=${encodeURIComponent("firstName desc")}`,
    );
  });
  ...
  it("should set orderByDescending with multiple fields", () => {
    ...
    expect(query.provider.buildQuery(query.expression)).to.be.eql(
      `${endpoint}?$orderby=${encodeURIComponent("firstName desc,lastName desc")}`,
    );
  });
  ...
  it("should set orderByDescending multiple times", () => {
    ...
    expect(query.provider.buildQuery(query.expression)).to.be.eql(
      `${endpoint}?$orderby=${encodeURIComponent("firstName desc,lastName desc,age desc")}`,
    );
  });
  ...
  it("should set orderBy and orderByDescending multiple times", () => {
    ...
    expect(query.provider.buildQuery(query.expression)).to.be.eql(
      `${endpoint}?$orderby=${encodeURIComponent("firstName desc,age,lastName desc")}`,
    );
  });
  ...
  it("should handle cumulative expands", () => {
    ...
    expect(query.provider.buildQuery(query.expression)).to.be.eql(
      `${endpoint}?$expand=${encodeURIComponent("children,mother")}`,
    );
  });
  ...
  it("should allow expand on non-array types", () => {
    ...
    expect(query.provider.buildQuery(query.expression)).to.be.eql(
      `${endpoint}?$expand=${encodeURIComponent("mother")}`,
    );
  });
  ...
  it("should find all properties", () => {
    ...
    expect(query.provider.buildQuery(query.expression)).to.be.eql(
      `${endpoint}?$select=${encodeURIComponent("email,firstName,mother/lastName")}`,
    );
  });
  ...
  it("should find all properties", () => {
    ...
    expect(query.provider.buildQuery(query.expression)).to.be.eql(
      `${endpoint}?$select=${encodeURIComponent("email,firstName,lastName,mother/lastName")}`,
    );
  });
});
