...
var expressionBuilder_1 = require("./expressionBuilder");
var ODataQuery = /** @class */ (function () {
    ...
    ODataQuery.prototype.select = function () {
        ...
        var expression = new expression_1.Expression('select', fields.map(function (v) { return new fieldReference_1.FieldReference(v); }), this.expression);
    ...
    ODataQuery.prototype.top = function (n) {
        var expression = new expression_1.Expression('top', [n], this.expression);
        return this.provider.createQuery(expression);
    };
    /**
    ...
    ODataQuery.prototype.skip = function (n) {
        var expression = new expression_1.Expression('skip', [n], this.expression);
        return this.provider.createQuery(expression);
    };
    /**
    ...
    ODataQuery.prototype.orderBy = function () {
        ...
        var expression = new expression_1.Expression('orderBy', fields.map(function (f) { return new fieldReference_1.FieldReference(f); }), this.expression);
        return this.provider.createQuery(expression);
    };
    /**
    ...
    ODataQuery.prototype.orderByDescending = function () {
        ...
        var expression = new expression_1.Expression('orderByDescending', fields.map(function (f) { return new fieldReference_1.FieldReference(f); }), this.expression);
        return this.provider.createQuery(expression);
    };
    /**
    ...
    ODataQuery.prototype.filter = function (predicate) {
        if (typeof predicate === "function")
            predicate = predicate(new expressionBuilder_1.PredicateBuilder());
        var expression = new expression_1.Expression('filter', [predicate], this.expression);
        return this.provider.createQuery(expression);
    };
    /**
